require([
    ...
    "esri/tasks/support/FindParameters",
	  ...
	  "dojo/aspect",
      "dojo/domReady!"
    ], function(Map, WebMap, MapView, Basemap, FeatureLayer, FindTask, Query, FindParameters, watchUtils, GraphicsLayer, Graphic, GroupLayer, MapImageLayer, WMSLayer, Home, Zoom, Compass, Search, Legend, BasemapToggle, BasemapGallery, ScaleBar, Attribution, LayerList, Print, Editor, Locate, Collapse, Dropdown, CalciteMaps, CalciteMapArcGISSupport, query, aspect) {
       ...
       ******************************************************************/     
		...
		var url = "http://www.kav-32.com:6080/arcgis/rest/services/sitangkal/MapServer/0";
		...
		/*url = "http://www.kav-32.com:6080/arcgis/rest/services/sitangkal/MapServer/1";
		...
		var fu = new WMSLayer({
			url: "https://datangahiji.cimahikota.go.id/geoserver/cmdbuild/wms",
			title: "Foto Udara",
			listMode: "hide-children",
			visible: false,
			sublayers: [{
				name: "cmdbuild:dronemap_dronemap_2092"
			}]
		})
